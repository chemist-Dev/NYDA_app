...
const Testimonials = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      type: "member",
      message:
        "كوني جزءاً من هذه الرابطة المميزة هو شرف كبير لي. العمل مع الفريق ممتع ومثمر، ونحن نشعر بالفخر عندما نرى تأثيرنا الإيجابي على المجتمع. أنصح كل طبيب شاب بالانضمام إلينا.",
      rating: 5,
      date: "18 ديسمبر 2024",
    },
    {
    ...
    },
    {
      ...
      type: "member",
      message:
        "العمل التطوعي مع الرابطة أعطاني الكثير من الخبرة والثقة في النفس. نحن نعمل كفريق واحد متماسك، والتنظيم ممتاز. أفخر بكوني جزءاً من هذا العمل الإنساني النبيل.",
      rating: 5,
      date: "12 ديسمبر 2024",
    },
    {
    ...
    },
    {
      ...
      type: "member",
      message:
        "انضممت للرابطة منذ سنتين وأعتبرها من أفضل القرارات في حياتي المهنية. نحن نتعلم من بعضنا البعض ونساعد المجتمع في نفس الوقت. جو الفريق رائع والهدف نبيل.",
      rating: 5,
      date: "8 ديسمبر 2024",
    },
  ];
